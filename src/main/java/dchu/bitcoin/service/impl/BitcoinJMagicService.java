...
public class BitcoinJMagicService implements BitcoinMagicService {
    ...
    public String createTransaction(String address, String targetAddress, Long amount) {
        ...
        try {
            Address sourceAddress = Address.fromString(networkParams,address);
...
//            }
            ...
            Address toAddress = Address.fromString(networkParams,targetAddress);
            ...
            if (total.isGreaterThan(coinAmount)) {
                ...
                TransactionOutput returnRest = new TransactionOutput(networkParams,transaction,returnamt,sourceAddress);
    ...
    public void watchAddress(String addressString) {
        try {
            Address address = Address.fromString(networkParams, addressString);
